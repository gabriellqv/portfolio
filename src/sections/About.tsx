  ...
  return (
    <section id="about" className="w-full max-w-5xl mx-auto px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {/* Bloco 1: Quem eu sou */}
        <div className="flex flex-col space-y-6 bg-card dark:bg-muted/15 border border-border/40 rounded-3xl p-8 lg:p-10 shadow-xl hover:shadow-2xl dark:hover:bg-muted/25 transition-all">
